...
PROPERTIES = (
    ...
    HubSpotProperty(
        object_type="companies",
        group_name="companyinformation",
        name="account_research_summary",
        label="Account Research Summary",
        description="Short sourced summary of what the company does and the researched sales context.",
        type="string",
        field_type="textarea",
    ),
    HubSpotProperty(
        object_type="companies",
        group_name="companyinformation",
        name="why_this_account",
        label="Why This Account",
        description="Source-backed reason this company is on the target list, beyond generic ICP fit.",
        type="string",
        field_type="textarea",
    ),
    HubSpotProperty(
        object_type="companies",
        group_name="companyinformation",
        name="problem_hypothesis",
        label="Problem Hypothesis",
        description="Likely business problem or opportunity inferred from researched account-level evidence.",
        type="string",
        field_type="textarea",
    ),
    HubSpotProperty(
        ...
        description="Observed source-backed evidence supporting the company problem hypothesis.",
        type="string",
        field_type="textarea",
    ),
    HubSpotProperty(
        object_type="companies",
        group_name="companyinformation",
        name="problem_reasoning",
        label="Problem Reasoning",
        description="Reasoning chain from observed evidence to the problem hypothesis, including caveats.",
        type="string",
        field_type="textarea",
    ),
    HubSpotProperty(
        object_type="companies",
        group_name="companyinformation",
        name="problem_confidence",
        label="Problem Confidence",
        description="Confidence level for the researched problem hypothesis.",
        type="enumeration",
        field_type="select",
        options=(
    ...
    HubSpotProperty(
        object_type="companies",
        group_name="companyinformation",
        name="personalization_evidence",
        label="Personalization Evidence",
        description="Best account-level source-backed hook for future outreach personalization.",
        type="string",
        field_type="textarea",
    ),
    HubSpotProperty(
        object_type="companies",
        group_name="companyinformation",
        name="evidence_source_urls",
        label="Evidence Source URLs",
        description="URLs or source names supporting account research, personalization, and fit claims.",
        type="string",
        field_type="textarea",
    ),
    HubSpotProperty(
        ...
        description="Confidence level for account research and personalization evidence.",
        type="enumeration",
        field_type="select",
        options=(
            {"label": "High", "value": "high"},
    ...
    HubSpotProperty(
        ...
        description="Source-agnostic depth label for the account research pass.",
        type="enumeration",
        field_type="select",
        options=(
    ...
    HubSpotProperty(
        ...
        description="Summary of source categories searched, useful findings, missing evidence, and research limitations.",
        type="string",
        field_type="textarea",
    ),
    HubSpotProperty(
        object_type="companies",
        group_name="companyinformation",
        name="last_researched_date",
        label="Last Researched Date",
        description="Date the account research evidence was last checked.",
        type="date",
        field_type="date",
    ),
    HubSpotProperty(
