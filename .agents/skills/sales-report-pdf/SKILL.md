...
description: "Use this Codex sales skill for AI SDR work. - **Title:** Professional Sales Report PDF Generator."
---

# Professional Sales Report PDF Generator

This is a Codex-native sales skill in the `sales-*` namespace. Use it directly with `$sales-report-pdf` or route to it from `$sales`.
...
1. The sales skill resources directory (where `.agents/skills/sales/` lives)
