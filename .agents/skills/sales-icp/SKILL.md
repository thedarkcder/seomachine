---
name: sales-icp
description: "Use this Codex sales skill for AI SDR work. - **Title:** Ideal Customer Profile Builder."
---

# Ideal Customer Profile Builder

This is a Codex-native sales skill in the `sales-*` namespace. Use it directly with `$sales-icp` or route to it from `$sales`.
...
Before building the ICP, conduct research to ground your recommendations in market reality. Use web search to validate your assumptions:
