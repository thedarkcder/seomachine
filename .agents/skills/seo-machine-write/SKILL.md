---
name: seo-machine-write
description: "Use for SEO Machine write work in Codex. Use this skill to create comprehensive, SEO-optimized long-form blog content."
---

# Write Skill

This is a Codex-native SEO Machine skill. Use it directly with `$seo-machine-write` and pass the same argument you would give the workflow, such as a topic, URL, file path, keyword, or options.
...
Use this skill to create comprehensive, SEO-optimized long-form blog content.
...
### Pre-Writing Review
- **Research Brief**: Review research brief from `$seo-machine-research` skill if available
...
### Scrubbing Process
1. **Invoke Scrubber**: Run `$seo-machine-scrub [file-path]` on the saved article file
...
### Example Workflow
```
1. Write article → Save to drafts$seo-machine-article-name-2025-10-31.md
2. IMMEDIATELY run: $seo-machine-scrub drafts$seo-machine-article-name-2025-10-31.md
3. Verify scrubbing statistics
4. THEN proceed with optimization specialists below
```

This ensures all published content is free of AI signatures before any further processing.

## Automatic Specialist Execution
After saving the main article, immediately execute optimization specialists:

### 1. Content Analyzer Specialist (NEW!)
- **Specialist**: `content-analyzer`
...
This new specialist uses 5 specialized analysis modules:
...
### 4. Internal Linker Specialist
- **Specialist**: `internal-linker`
- **Input**: Article content
- **Output**: Specific internal linking recommendations
- **File**: `drafts/link-suggestions-[topic-slug]-[YYYY-MM-DD].md`

### 5. Keyword Mapper Specialist
- **Specialist**: `keyword-mapper`
...
- **Score ≥ 70**: Save to `drafts/` and proceed to optimization specialists
