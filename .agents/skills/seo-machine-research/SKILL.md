---
name: seo-machine-research
description: "Use for SEO Machine research work in Codex. Use this skill to conduct comprehensive SEO keyword research and competitive analysis before writing new content."
---

# Research Skill

This is a Codex-native SEO Machine skill. Use it directly with `$seo-machine-research` and pass the same argument you would give the workflow, such as a topic, URL, file path, keyword, or options.
...
Use this skill to conduct comprehensive SEO keyword research and competitive analysis before writing new content.
...
1. Running `$seo-machine-write [topic]` to create the optimized article
