---
name: seo-machine-research-ai-citations
description: "Use for SEO Machine research-ai-citations work in Codex. Generate high-commercial-intent prompts for a topic, cluster them, and create an audit template for tracking which sources AI tools cite. This is the prompt-driven research counterpart to traditional keyword research."
---

# Research AI Citations Skill

This is a Codex-native SEO Machine skill. Use it directly with `$seo-machine-research-ai-citations` and pass the same argument you would give the workflow, such as a topic, URL, file path, keyword, or options.
...
## Codex Invocation
`$seo-machine-research-ai-citations [topic or keyword]`

**Examples:**
- `$seo-machine-research-ai-citations "project management tools"`
- `$seo-machine-research-ai-citations "email marketing platform"`
- `$seo-machine-research-ai-citations "CRM for small businesses"`
...
1. **Where is your brand present?** List prompts$seo-machine-clusters where you appear
2. **Where is your brand absent?** List prompts$seo-machine-clusters where you should appear but don't
...
- **Before `$seo-machine-article`**: Run `$seo-machine-research-ai-citations` first to understand which prompts the article should target and which sources to reference
- **After `$seo-machine-publish-draft`**: Run `$seo-machine-repurpose` to distribute the article across citation surfaces identified here
