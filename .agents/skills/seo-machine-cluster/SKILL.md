---
name: seo-machine-cluster
description: "Use for SEO Machine cluster work in Codex. Build a complete topic cluster strategy with pillar page definition, 8-12 supporting articles, internal linking map, and creation sequence."
---

# Cluster Skill

This is a Codex-native SEO Machine skill. Use it directly with `$seo-machine-cluster` and pass the same argument you would give the workflow, such as a topic, URL, file path, keyword, or options.
...
## Codex Invocation
`$seo-machine-cluster [topic]`

**Examples:**
- `$seo-machine-cluster "content marketing"`
- `$seo-machine-cluster "podcast monetization"`
- `$seo-machine-cluster "remote team management"`
...
1. Search `research/` for any existing `$seo-machine-research-topics` output:
   ```
...
Adopt the **cluster-strategist** specialist role (@specialists$seo-machine-cluster-strategist.md).
...
**Copy-Pastable Skills:**
For each piece, provide the exact skill:
```
$seo-machine-research "[primary keyword]"
$seo-machine-article "[article title]"
```

## Output

Save to: `research$seo-machine-cluster-strategy-[topic-slug]-[YYYY-MM-DD].md`
...
| Order | Piece | Skill |
|-------|-------|---------|
| 1 | [Pillar: Title] | `$seo-machine-research "[keyword]"` then `$seo-machine-article "[title]"` |
| 2 | [Article X: Title] | `$seo-machine-research "[keyword]"` then `$seo-machine-article "[title]"` |
| 3 | [Article Y: Title] | `$seo-machine-research "[keyword]"` then `$seo-machine-article "[title]"` |

### Phase 2: Build Authority
| Order | Piece | Skill |
|-------|-------|---------|
| 4 | [Article X: Title] | `$seo-machine-research "[keyword]"` then `$seo-machine-article "[title]"` |
[...]

### Phase 3: Complete Coverage
| Order | Piece | Skill |
|-------|-------|---------|
| 8 | [Article X: Title] | `$seo-machine-research "[keyword]"` then `$seo-machine-article "[title]"` |
[...]
