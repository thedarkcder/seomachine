---
name: seo-machine-landing-page-optimizer-specialist
description: "Use for SEO Machine landing page optimizer specialist work in Codex. Identify elements that create friction or hesitation:."
---
...
- `$seo-machine-landing-write` creates a new landing page
- `$seo-machine-landing-audit` completes an audit
