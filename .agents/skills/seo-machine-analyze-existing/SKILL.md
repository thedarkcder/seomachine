---
name: seo-machine-analyze-existing
description: "Use for SEO Machine analyze-existing work in Codex. Use this skill to review and analyze existing your company blog posts for SEO opportunities, content gaps, and improvement areas."
---

# Analyze Existing Skill

This is a Codex-native SEO Machine skill. Use it directly with `$seo-machine-analyze-existing` and pass the same argument you would give the workflow, such as a topic, URL, file path, keyword, or options.
...
Use this skill to review and analyze existing your company blog posts for SEO opportunities, content gaps, and improvement areas.
...
The new Content Analyzer specialist provides:
...
1. Running `$seo-machine-rewrite [topic]` if content needs significant updates
2. Running `$seo-machine-optimize [file]` if content needs light SEO polish
