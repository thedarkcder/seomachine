---
name: seo-machine-repurpose
description: "Use for SEO Machine repurpose work in Codex. Take a published or drafted article and generate platform-specific versions for distribution across multiple content surfaces, maximizing AI citation potential."
---

# Repurpose Skill

This is a Codex-native SEO Machine skill. Use it directly with `$seo-machine-repurpose` and pass the same argument you would give the workflow, such as a topic, URL, file path, keyword, or options.
...
## Codex Invocation
`$seo-machine-repurpose [path-to-article]`

**Examples:**
- `$seo-machine-repurpose drafts/project-management-guide-2026-04-10.md`
- `$seo-machine-repurpose published/start-a-blog.md`
...
One article should become 4-5 pieces of distributed content. This skill automates the adaptation, not just copy-pasting.
