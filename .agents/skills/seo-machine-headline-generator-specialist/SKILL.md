---
name: seo-machine-headline-generator-specialist
description: "Use for SEO Machine headline generator specialist work in Codex. Perform SEO Machine headline-generator specialist review."
---

# Headline Generator Specialist
...
- After `$seo-machine-landing-write` creates a new landing page
- After `$seo-machine-landing-audit` identifies weak headlines
- When preparing A/B tests for existing pages
- During `$seo-machine-landing-research` for competitive positioning
