---
name: seo-machine-article
description: "Use for SEO Machine article work in Codex. A unified content creation pipeline that produces comprehensive, SEO-optimized articles through mandatory research, strategic planning, and section-by-section writing."
---

# Article Skill

This is a Codex-native SEO Machine skill. Use it directly with `$seo-machine-article` and pass the same argument you would give the workflow, such as a topic, URL, file path, keyword, or options.
...
**Examples:**
- `$seo-machine-article "Best Project Management Tools for Small Teams"`
- `$seo-machine-article "Content Marketing Strategy Guide 2025"`
- `$seo-machine-article "How to Migrate from Competitor to Your Product"`
...
## When to Use This vs $seo-machine-write

| Scenario | Skill |
|----------|---------|
| Comprehensive new article | `$seo-machine-article` |
| Competitive topics | `$seo-machine-article` |
| Topics where you need to beat existing content | `$seo-machine-article` |
| Quick drafts from existing research | `$seo-machine-write` |
| Simple updates to existing content | `$seo-machine-write` |
...
### Output
Save to: `research$seo-machine-article-plan-[topic-slug]-[YYYY-MM-DD].md`
...
### 1. Scrub AI Patterns
```
$seo-machine-scrub drafts/[filename].md
```
...
### 4. Run Optimization Specialists
After passing quality threshold:
- `content-analyzer` specialist
