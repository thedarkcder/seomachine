---
name: sales-report
description: "Use this Codex sales skill for AI SDR work. - **Title:** Sales Pipeline Report Generator."
---

# Sales Pipeline Report Generator

This is a Codex-native sales skill in the `sales-*` namespace. Use it directly with `$sales-report` or route to it from `$sales`.
...
- `COMPANY-RESEARCH.md` -- Company research specialist output
