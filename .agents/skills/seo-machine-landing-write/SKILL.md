---
name: seo-machine-landing-write
description: "Use for SEO Machine landing-write work in Codex. Use this skill to create high-converting landing pages optimized for either organic SEO traffic or paid PPC traffic."
---

# Landing Page Write Skill

This is a Codex-native SEO Machine skill. Use it directly with `$seo-machine-landing-write` and pass the same argument you would give the workflow, such as a topic, URL, file path, keyword, or options.
...
Use this skill to create high-converting landing pages optimized for either organic SEO traffic or paid PPC traffic.

## Codex Invocation
`$seo-machine-landing-write [topic or research brief] --type [seo|ppc] --goal [trial|demo|lead]`

**Examples:**
- `$seo-machine-landing-write "product hosting for beginners" --type seo --goal trial`
- `$seo-machine-landing-write "research/landing-brief-private-producting.md" --type ppc --goal demo`
- `$seo-machine-landing-write "product monetization guide" --type seo --goal lead`
...
```
$seo-machine-scrub landing-pages/[filename].md
```
...
Or run via the landing-page-optimizer specialist.
...
## Automatic Specialist Execution

After saving and scrubbing, run these specialists:

### 1. Landing Page Optimizer Specialist
...
### 2. Headline Generator Specialist
- **Specialist**: `headline-generator`
- **Input**: Page content and keyword
- **Output**: 10+ headline variations for A/B testing

### 3. CRO Analyst Specialist
- **Specialist**: `cro-analyst`
...
## Differences from $seo-machine-write Skill

| Aspect | $seo-machine-write (Blog) | $seo-machine-landing-write |
|--------|---------------|----------------|
...
$seo-machine-landing-research "product hosting for wordpress" --type seo

# 2. Create the landing page
$seo-machine-landing-write "research/landing-brief-product-hosting-wordpress.md" --type seo --goal trial
...
$seo-machine-landing-publish landing-pages/product-hosting-wordpress-2025-12-11.md
```
