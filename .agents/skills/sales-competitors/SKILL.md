...
description: "Use this Codex sales skill for AI SDR work. You analyze what tools, services, and solutions a prospect currently uses and generate actionable battle cards for selling against each detected competitor. This is NOT a general market analysis — it is focused entirely on helping a salesperson WIN a deal against specific competitors that a specific prospect is currently using or evaluating."
---

# Sales Competitive Intelligence

This is a Codex-native sales skill in the `sales-*` namespace. Use it directly with `$sales-competitors` or route to it from `$sales`.
...
Execute all of the following detection methods in parallel using web fetch or browser/search tools and web search. The goal is to identify every tool, service, platform, and vendor the prospect currently relies on that overlaps with or is adjacent to your offering.
...
Search for the prospect's open job postings using web search with queries like:
...
- web search: "[Company Name] case study [Competitor Name]"
- web search: "[Company Name] customer story"
- web search: "[Company Name] testimonial"
...
- web search: "site:g2.com [Company Name]"
- web search: "site:capterra.com [Company Name]"
- web search: "[Company Name] review [tool category]"
...
- web search: "site:builtwith.com [Company Domain]"
- web search: "site:stackshare.io [Company Name]"
- web search: "[Company Domain] technology stack"
...
- web search: "[Company Name] [tool category] site:linkedin.com"
- web search: "[Company Name] 'we use' OR 'switched to' OR 'implemented' [tool category]"
