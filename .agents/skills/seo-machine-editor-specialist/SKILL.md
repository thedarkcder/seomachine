---
name: seo-machine-editor-specialist
description: "Use for SEO Machine editor specialist work in Codex. Perform SEO Machine editor specialist review."
---

# Editor Specialist

This is a Codex-native SEO Machine specialist skill. Use it when a workflow needs this review pass or when the user directly asks for this type of analysis.

## Codex Operating Notes

- Read the artifact being reviewed and the relevant `context/` files before scoring or recommending edits.
- Prefer concrete, section-specific recommendations over generic advice.
- When metrics or API data are unavailable, state the missing source and continue with static analysis.
...
When the editor specialist is invoked as part of an automated quality loop, include a JSON block at the end of your response with structured scoring data:
...
This structured output enables the automated quality loop in `$seo-machine-write` to parse your feedback and apply revisions programmatically.
