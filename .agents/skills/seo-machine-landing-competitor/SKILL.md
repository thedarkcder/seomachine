---
name: seo-machine-landing-competitor
description: "Use for SEO Machine landing-competitor work in Codex. Use this skill to analyze a specific competitor's landing page in depth."
---

# Landing Page Competitor Analysis Skill

This is a Codex-native SEO Machine skill. Use it directly with `$seo-machine-landing-competitor` and pass the same argument you would give the workflow, such as a topic, URL, file path, keyword, or options.
...
Use this skill to analyze a specific competitor's landing page in depth.

## Codex Invocation
`$seo-machine-landing-competitor [URL]`

**Examples:**
- `$seo-machine-landing-competitor https://competitor1.com/pricing/`
- `$seo-machine-landing-competitor https://competitor2.com/features/`
- `$seo-machine-landing-competitor https://competitor3.com/product/`
...
$seo-machine-landing-write "[topic]" --type seo --goal trial
```

**Compare Multiple Competitors:**
```
$seo-machine-landing-competitor [url1]
$seo-machine-landing-competitor [url2]
$seo-machine-landing-competitor [url3]
# Then synthesize findings
```

**Audit [YOUR COMPANY] vs Competitor:**
```
$seo-machine-landing-audit https://yoursite.com/[page]/
$seo-machine-landing-competitor https://competitor.com/[page]/
