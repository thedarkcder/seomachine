---
name: seo-machine-landing-audit
description: "Use for SEO Machine landing-audit work in Codex. Use this skill to audit existing landing pages for conversion optimization opportunities."
---

# Landing Page Audit Skill

This is a Codex-native SEO Machine skill. Use it directly with `$seo-machine-landing-audit` and pass the same argument you would give the workflow, such as a topic, URL, file path, keyword, or options.
...
Use this skill to audit existing landing pages for conversion optimization opportunities.

## Codex Invocation
`$seo-machine-landing-audit [URL or file path] --goal [trial|demo|lead]`

**Examples:**
- `$seo-machine-landing-audit https://yoursite.com/private-producting-solutions/`
- `$seo-machine-landing-audit landing-pages/product-hosting-beginners-2025-12-11.md --goal trial`
- `$seo-machine-landing-audit https://yoursite.com/pricing/ --goal trial`
...
- **Example**: `audits$seo-machine-landing-audit-private-producting-solutions-2025-12-11.md`
...
```
$seo-machine-landing-audit https://yoursite.com/pricing/
$seo-machine-landing-competitor https://competitor.com/pricing/
```
...
**After Audit:**
1. Use findings to create improved version: `$seo-machine-landing-write [topic] --type [type] --goal [goal]`
2. Or run competitor analysis: `$seo-machine-landing-competitor [url]`
3. Or generate new headlines: Specialist `headline-generator`

**Before Publishing:**
1. Run audit on draft: `$seo-machine-landing-audit landing-pages/[file].md`
2. Fix critical issues
3. Re-audit until score ≥ 75
4. Publish: `$seo-machine-landing-publish landing-pages/[file].md`
