---
name: seo-machine-optimize
description: "Use for SEO Machine optimize work in Codex. Use this skill to perform a final SEO optimization pass on completed articles before publishing."
---

# Optimize Skill

This is a Codex-native SEO Machine skill. Use it directly with `$seo-machine-optimize` and pass the same argument you would give the workflow, such as a topic, URL, file path, keyword, or options.
...
Use this skill to perform a final SEO optimization pass on completed articles before publishing.
...
The `$seo-machine-optimize` skill triggers final review from all specialists:
...
The optimize skill now includes advanced SEO analysis:
