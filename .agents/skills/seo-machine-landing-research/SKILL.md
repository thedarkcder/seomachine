---
name: seo-machine-landing-research
description: "Use for SEO Machine landing-research work in Codex. Use this skill to research a landing page opportunity before creating it. Analyzes competitors, keywords, and provides strategic recommendations."
---

# Landing Page Research Skill

This is a Codex-native SEO Machine skill. Use it directly with `$seo-machine-landing-research` and pass the same argument you would give the workflow, such as a topic, URL, file path, keyword, or options.
...
Use this skill to research a landing page opportunity before creating it. Analyzes competitors, keywords, and provides strategic recommendations.

## Codex Invocation
`$seo-machine-landing-research [topic or keyword] --type [seo|ppc]`

**Examples:**
- `$seo-machine-landing-research "product hosting for beginners" --type seo`
- `$seo-machine-landing-research "product free trial" --type ppc`
- `$seo-machine-landing-research "private producting solutions"`
...
5. Creates a research brief for `$seo-machine-landing-write`
...
```
$seo-machine-landing-write research/landing-brief-[slug].md --type [seo|ppc] --goal [trial|demo|lead]
```
```
...
**After Research:**
```
$seo-machine-landing-write research/landing-brief-[slug].md --type [type] --goal [goal]
```

**For Competitor Deep Dive:**
```
$seo-machine-landing-competitor [specific-competitor-url]
```

**For Existing Page Updates:**
```
$seo-machine-landing-audit [existing-page-url]
```
